...
// Twilio credentials (set as env vars)
...
const OPERATOR_PHONE = process.env.OPERATOR_PHONE || '+16043518525'; // Your phone to receive handoff
...
If the customer asks something outside your scope, offer to transfer them to a human agent.`;
    ...
    const twiml = new twilio.tviml.VoiceResponse();
...
server.listen(PORT, () => {
  ...
  console.log(`   Incoming: POST http://your-domain.com/call/incoming`);
  console.log(`   Ended: POST http://your-domain.com/call/ended`);
});
